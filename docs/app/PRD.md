...
Suggested path: administer it outside the app for beta 1 (paper, PDF, or
facilitator-led), however you'd planned to before the app existed. Once
you've chosen the instrument, a later phase can add a simple
facilitator/admin-entered results field that shows up in a student's My
Progress — display only, not administering the assessment itself.
